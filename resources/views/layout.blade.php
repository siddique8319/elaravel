...
<head>
    ...
    <link href="{{asset('frontend/css/prettyPhoto.css')}}" re l="stylesheet">
...
{{--                        <li data-target="#slider-carousel" data-slide-to="2"></li>--}}
                    ...
                    @php
                        $slider = DB::table('tbl_slider')->latest()->where('publication_status',1)
                        ->get();
                    @endphp
...
//                    foreach($all_published_slider as $v_slider){?>
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            ...
                            <div class="col-sm-6">
                                <img src="{{url($v_slider->slider_image)}}" class="girl img-responsive"
                                     alt=""/>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="#">{{$v_category->
                                category_name}}</a></h4>
                                </div>
                            </div>
                            <?php }?>
                    ...
                    <div class="brands_products"><!--brands_products-->
                        ...
                        <div class="brands-name">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="#"> <span class="pull-right">(50)</span>{{$v_manufacture->
                               manufacture_name}}</a></li>
                                <?php }?>
                            </ul>
                        </div>
                    </div><!--/brands_products-->
